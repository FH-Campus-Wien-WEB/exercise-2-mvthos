...
1. Using HTML landmark elements we restructure our `body` to this:
    ...
    ![Basic structure of the page](../CloudWebDummy/images/structure.svg "Basic structure of the page")
...
2. In this task we are going to use CSS Grid Template Areas to change our layout to look like this:
    ...
    ![Styled structure of the page](../CloudWebDummy/images/structure-styled.svg "Styled structure of the page")
...
![Page without data](../CloudWebDummy/images/without-data.jpg "Page without data")
...
1. We specify an element to be a Grid container and specify the areas the container will use. In project, the `body` element is the Grid container.
    ...
    ![Columns and rows](../CloudWebDummy/images/grid-columns-and-rows.svg "Columns and rows")
...
2. Now, assign the areas defined in the container in step 1 to the child elements of our container. These are `header`, `nav`, `main`, and `footer`.
    ...
    ![Laid out with grid](../CloudWebDummy/images/with-grid-layout.jpg "Laid out with grid")
...
![The final result](../CloudWebDummy/images/final.jpg "A screenshot of the final result")
